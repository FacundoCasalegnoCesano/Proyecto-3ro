    ...
    <div className="bg-white rounded-xl shadow-sm overflow-hidden">
      <div className={`grid grid-cols-1 lg:grid-cols-2 ${reverse ? "lg:grid-flow-col-dense" : ""}`}>
        ...
        <div className={`relative ${reverse ? "lg:col-start-1" : ""}`}>
          <div className="relative aspect-[4/3]"> {/* Ratio 4:3 para 800x600px */}
            <div className="absolute inset-0 p-4 lg:p-6"> {/* Reducido padding */}
              <div className="bg-babalu-primary rounded-2xl h-full w-full p-2 lg:p-3"> {/* Padding reducido */}
                <div className="bg-white rounded-xl h-full w-full flex items-center justify-center p-1 lg:p-2 overflow-hidden"> {/* Padding mínimo */}
