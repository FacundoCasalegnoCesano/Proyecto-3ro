...
import { Search, Filter, Download, Eye, Package, Clock, CheckCircle, XCircle, ChevronDown } from "lucide-react"
  ...
  return (
    <div className="space-y-6">
      ...
      <div className="flex flex-col sm:flex-row justify-between items-start sm:items-center gap-4">
        ...
        <Button onClick={onExportOrders} className="bg-babalu-primary hover:bg-babalu-medium text-white">
                    ...
                    <div>
                      ...
                      <div className="mt-4 p-4 bg-babalu-light rounded-lg space-y-2">
                        ...
                        <div className="flex justify-between text-lg font-bold pt-2 border-t border-babalu-medium">
                          ...
                          <span className="text-babalu-primary">${order.total.toLocaleString()}</span>
                        </div>
                      </div>
                    </div>
                  </div>
