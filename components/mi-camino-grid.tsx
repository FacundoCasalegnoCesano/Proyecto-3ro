  ...
  const sections: MiCaminoSection[] = [
    {
      ...
      image: "/placeholder.svg?height=300&width=400&text=About+Me&bg=DF6C3B",
    },
    {
      id: "mi-area-trabajo",
      title: "Mi Area De Trabajo",
      content: `Lorem ipsum dolor sit amet, consectetur adipiscing elit, sed do eiusmod tempor incididunt ut labore et dolore magna aliqua. Ut enim ad minim veniam, quis nostrud exercitation ullamco laboris nisi ut aliquip ex ea commodo consequat.`,
      image: "/placeholder.svg?height=300&width=400&text=Work+Area&bg=DF6C3B",
    },
    {
      id: "mi-formacion",
      title: "Mi Formación",
      ...
      image: "/placeholder.svg?height=300&width=400&text=Training&bg=DF6C3B",
    },
    {
      id: "mi-mision",
      title: "Mi Misión",
      ...
      image: "/placeholder.svg?height=300&width=400&text=Mission&bg=DF6C3B",
    },
    {
      id: "mi-filosofia",
      title: "Mi Filosofía",
      ...
      image: "/placeholder.svg?height=300&width=400&text=Philosophy&bg=DF6C3B",
    },
    {
      id: "mi-espacio",
      ...
      image: "/placeholder.svg?height=300&width=400&text=Sacred+Space&bg=DF6C3B",
    },
  ]
