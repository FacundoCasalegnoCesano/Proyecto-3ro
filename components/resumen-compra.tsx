  ...
  return (
    <div className="bg-white rounded-lg shadow-sm p-6 sticky top-6">
      ...
      {shippingOption && (
        <div className="mt-4 p-3 bg-blue-50 border border-blue-200 rounded-lg">
          <p className="text-sm text-blue-800">
            <strong>Entrega estimada:</strong> {shippingOption.deliveryDays}{" "}
            días hábiles
          </p>
      ...
      <div className="mt-6 p-4 bg-babalu-primary/10 rounded-lg">
        <h4 className="text-sm font-medium text-babalu-primary mb-2">
          ¿Necesitas ayuda?
        </h4>
        <p className="text-xs text-gray-600 mb-2">
          Contáctanos si tienes alguna duda sobre tu pedido
        </p>
